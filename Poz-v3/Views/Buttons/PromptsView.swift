...
//        Prompt(name: "Idea", color: Color(#colorLiteral(red: 0.7816649079, green: 0.9041231275, blue: 1, alpha: 1)), emoji: "💡", prompt: "What made you smile today?", index: 1),
        Prompt(name: "Note to self", color: Color(#colorLiteral(red: 0.9835988879, green: 0.9287452102, blue: 0.8802834153, alpha: 1)), emoji: "📝", subtext: "What made you smile today?", index: 2, prompt: ""),
        Prompt(name: "Reflection", color: Color(#colorLiteral(red: 0.8686004281, green: 0.8755119443, blue: 0.992816627, alpha: 1)), emoji: "🔮", subtext: "What made you smile today?", index: 3, prompt: ""),
...
struct PromptsViewC: View {
    ...
    //create prompts
    let prompts:[Prompt] = [
        Prompt(name: "Note to self", color: Color(#colorLiteral(red: 0.9835988879, green: 0.9287452102, blue: 0.8802834153, alpha: 1)), emoji: "📝", subtext: "Gets sent back to you at a later date", index: 2, prompt: ""),
        Prompt(name: "Reflection", color: Color(#colorLiteral(red: 0.8686004281, green: 0.8755119443, blue: 0.992816627, alpha: 1)), emoji: "🔮", subtext: "Provides introspective questions", index: 3, prompt: ""),
        Prompt(name: "Gratitude", color: Color(#colorLiteral(red: 1, green: 0.8794577122, blue: 1, alpha: 1)), emoji: "🙏🏾", subtext: "Looks on the bright side", index: 8, prompt: ""),
        Prompt(name: "Vent", color: Color(#colorLiteral(red: 1, green: 0.8935509324, blue: 0.8957810998, alpha: 1)), emoji: "💢", subtext: "Gets autodeleted after 1 week", index: 7, prompt: ""),
//        Prompt(name: "Decompress", color: Color(#colorLiteral(red: 0.9080274105, green: 0.920806706, blue: 1, alpha: 1)), emoji: "💤", prompt: "What made you smile today?", index: 9)
    ]
